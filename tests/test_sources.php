...
//  private $private_key = '5397c5fc8715349f34dd71027b19422f';
  ...
  function testGetSources() {  
    ...
    $data = $this->ceenRU->CEERNResourceCall($this->ceen_location . '/source.php', 'GET', NULL, FALSE, 'source_resource.index');
...
//	$this->assertTrue(1==1);
  ...
  function testGetSource( $uuid='97f26cde-a6fc-11df-8932-4040e8acc39d') {  
    ...
    $data = $this->ceenRU->CEERNResourceCall($this->ceen_location.'/source'.'/'.$uuid.'.php', 'GET', NULL, FALSE, 'source_resource.retrieve');
...
//	$this->assertTrue(1==1);
   ...
   */ 
/*
  function CEERNResourceCallSource($url, $method = 'GET', $data = array(), $authenticate = FALSE, $resource_name = '', $output = TRUE) {
